...
void lv_g2d_insert_buf_map(void * key, struct g2d_buf * value)
{
...
struct g2d_buf * lv_g2d_search_buf_map(void * key)
{
    int index = _map_hash_function(key);
...
void lv_g2d_free_item(void * key)
{
