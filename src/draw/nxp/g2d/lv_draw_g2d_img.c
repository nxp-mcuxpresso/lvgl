...
void lv_draw_g2d_img(lv_draw_task_t * t, const lv_draw_image_dsc_t * dsc, const lv_area_t * coords)
{
    ...
    /* Destination buffer */
    struct g2d_buf * dst_buf = lv_g2d_search_buf_map(draw_buf->data);
...
{
    struct g2d_buf * src_buf = lv_g2d_search_buf_map((void *)img_dsc->data);
    ...
    if(src_buf == NULL) {
        ...
        lv_g2d_insert_buf_map((void *)img_dsc->data, src_buf);
    }

    return src_buf;
}

void _g2d_set_src_surf(struct g2d_surface * src_surf, struct g2d_buf * buf, const lv_area_t * area, int32_t stride,
...
void _g2d_set_dst_surf(struct g2d_surface * dst_surf, struct g2d_buf * buf, const lv_area_t * area, int32_t stride,
